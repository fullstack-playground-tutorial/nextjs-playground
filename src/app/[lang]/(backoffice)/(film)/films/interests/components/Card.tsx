...
function Card({
  ...
  return (
    <>
      <div className="flex flex-col items-start justify-start gap-2 xl:w-70 xl:h-42 max-h-42 h-auto md:w-56 p-4 rounded-xl shadow-sm hover:shadow-md dark:bg-surface-1 border border-border">
