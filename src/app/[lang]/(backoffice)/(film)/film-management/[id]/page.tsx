...
export default async function Page(props: {
    ...
    return (
        <div className="min-h-screen dark:bg-surface-0 dark:text-primary animate-in fade-in duration-700 pb-12">
                ...
                <div className="flex-1 lg:pt-14">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
                        ...
                        <div className="flex gap-4 shrink-0">
                            <Link
                                href={`/${lang}/film-management/${film.id}/edit`}
                                className="flex items-center gap-2 px-8 py-3.5 bg-accent-0 hover:bg-accent-1 text-white rounded-2xl shadow-[0_10px_20px_rgba(255,183,77,0.3)] transition-all hover:-translate-y-1 font-bold whitespace-nowrap"
                            >
